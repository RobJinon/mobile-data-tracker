        ...
        <div>
            ...
            <div className='flex flex-col w-full hidden lg:block'>
                <div className='flex flex-col w-full gap-2'>
                    <div className='text-center bg-primary py-4 text-xl text-white rounded-t-lg font-bold'>My ISPs</div>

                    {ispList.map((isp, index) => (
                        index % 2 == 0 ?
                            <div className='w-full px-3'><a className='btn w-full btn-primary'>{isp}</a></div>
                        :
                            <div className='w-full px-3'><a className='btn w-full bg-base-300 border-0'>{isp}</a></div>
                    ))}
